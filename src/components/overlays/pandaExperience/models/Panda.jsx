...
export default function Model({ scrollProgress, cameraScrollCurve, initialLoopCounter = 1, ...props }) {
  ...
  const initialPandaPoint = pandaScrollCurve.getCurrentPoint(scrollProgress.current);
  const currentTextureRef = useRef(getCurrentTexture(scrollProgress.current));
  ...
  return (
    <group {...props} dispose={null}>
      <mesh
        ...
        position={[initialPandaPoint.x, initialPandaPoint.y, initialPandaPoint.z]}
